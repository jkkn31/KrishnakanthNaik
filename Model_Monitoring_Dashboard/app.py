...
if task == 'Data Monitoring':
    ...
    x1 = pd.read_csv("Model_Monitoring_Dashboard/data/hw_m1.csv")
    x1['Model'] = 'Model_1'
    x2 = pd.read_csv("Model_Monitoring_Dashboard/data/hw_m2.csv")
    x2['Model'] = 'Model_2'

    x3 = pd.read_csv("Model_Monitoring_Dashboard/data/hw_m3.csv")
    x3['Model'] = 'Model_3'

    x4 = pd.read_csv("Model_Monitoring_Dashboard/data/hw_m1.csv")
    x4['Model'] = 'Model_4'
    ...
    m4 = pd.read_csv("Model_Monitoring_Dashboard/data/model_1_mm.csv")
    m1['Model'] = 'Model_1'
    m2['Model'] = 'Model_2'
    m3['Model'] = 'Model_3'
    m4['Model'] = 'Model_4'
    ...
    # Job API Table
    inference_pipeline = pd.read_csv("Model_Monitoring_Dashboard/data/job_api_status.csv")
